...
vector_field := mat((x2, 9.8 * (x1 - x1^3 / 6) + ctrl_output))$
init := x1 >= -3.1416 / 9 and x1 <= 3.1416 / 9 and x2 >= -3.1416 / 9 and x2 <= 3.1416 / 9$
domain := x1 >= -3.1416 / 2 and x1 <= 3.1416 / 2 and x2 >= -3.1416 / 2 and x2 <= 3.1416 / 2$
unsafe := domain and (not (x1 > -3.14159 / 6 and x1 < 3.14159 / 6 and x2 > -3.14159 / 6 and x2 < 3.14159 / 6))$
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
