...
RADIUS_ASYMP = 0.2 # set the radius of the neighborhood around the asymptotic stability point
...
DECAY_INIT = 1
DECAY_UNSAFE = 1
DECAY_ASYMP = 0.01 # set the weight of the asymptotic stability loss
