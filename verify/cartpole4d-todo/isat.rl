...
normed_force := ctrl_output$
dd_theta := gravity * sin(x2) - normed_force * cos(x2)$
dd_x := normed_force$

vector_field := mat((x3, x4, dd_x, dd_theta))$
init := x1 >= -0.05 and x1 <= 0.05 and x2 >= -0.05 and x2 <= 0.05 and x3 >= -0.05 and x3 <= 0.05 and x4 >= -0.05 and x4 <= 0.05$
domain := x1 >= -2 and x1 <= 2 and x2 >= -1 and x2 <= 1 and x3 >= -2 and x3 <= 2 and x4 >= -2 and x4 <= 2$
unsafe := domain and (not(x1 > -2 and x1 < 2 and x2 > -1 and x2 < 1 and x3 > -2 and x3 < 2 and x4 > -2 and x4 < 2))$
...
write "DECL"$
write "real [-1, 1] x1"$
write "real [-0.5, 0.5] x2"$
write "real [-1, 1] x3"$
write "real [-1, 1] x4"$
for i:=1 step 1 until barr_dim do 
<< write "real [-10000000000, 10000000000] ", barr_output_hidden(i, 1); >>$
for i:=1 step 1 until barr_dim do 
