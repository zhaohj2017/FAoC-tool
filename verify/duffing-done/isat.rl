...
vector_field := mat((x2, -0.6 * x2 - x1 - x1^3 + ctrl_output))$
init := x1 >= -2.5 and x1 <= 2.5 and x2 >= -2 and x2 <= 2$
domain := x1 >= -6 and x1 <= 6 and x2 >= -6 and x2 <= 6$
unsafe := domain and (not (x1 > -5 and x1 < 5 and x2 > -5 and x2 < 5))$
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
