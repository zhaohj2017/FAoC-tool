...
deri_2 := 30 * (sin(x1) + 0.5 * ctrl * cos(x1))$
deri_3 := cos(x3) * (ctrl * cos(x3) - 20 * sin(x3))$
vector_field := mat((x2, deri_2, deri_3))$
init := x1 >= -3.1416 / 30 and x1 <= 3.1416 / 30 and x2 >= -3.1416 / 30 and x2 <= 3.1416 / 30 and x3 >= -3.1416 / 30 and x3 <= 3.1416 / 30$
domain := x1 >= -3.1416 / 2.5 and x1 <= 3.1416 / 2.5 and x2 >= -3.1416 / 2.5 and x2 <= 3.1416 / 2.5 and x3 >= -3.1416 / 2.5 and x3 <= 3.1416 / 2.5$
unsafe := domain and (not (x1 > -3.14159 / 3 and x1 < 3.14159 / 3 and x2 > -3.14159 / 3 and x2 < 3.14159 / 3 and x3 > -3.14159 / 3 and x3 < 3.14159 / 3))$
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
cons_lie := domain and app_bent and barr_output = 0 and app_deri_bent and ctrl = ctrl_output and lie >= 0$
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%generate initial condition%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
out "init_veri.hy"$
write "DECL"$
write "real [-1.25 - 1 / 128, 1.25 + 1 / 128] x1"$
write "real [-1.25 - 1 / 128, 1.25 + 1 / 128] x2"$
write "real [-1.25 - 1 / 128, 1.25 + 1 / 128] x3"$
...
write "real [-1.25 - 1 / 128, 1.25 + 1 / 128] x2"$
write "real [-1.25 - 1 / 128, 1.25 + 1 / 128] x3"$
write "real [-10000000000, 10000000000] ctrl"$
for i:=1 step 1 until barr_dim do 
<< write "real [0, 10000000000] ", barr_output_hidden(i, 1); >>$
for i:=1 step 1 until barr_dim do 
